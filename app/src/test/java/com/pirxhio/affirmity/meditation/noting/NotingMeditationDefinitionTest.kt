...
class NotingMeditationDefinitionTest {
    ...
    @Test
    fun `runs breath anchor, noting, then open awareness - 3 phases`() {
        val executor = RecordingCommandExecutor()
        val engine = MeditationEngine(notingMeditationDefinition(), executor)
