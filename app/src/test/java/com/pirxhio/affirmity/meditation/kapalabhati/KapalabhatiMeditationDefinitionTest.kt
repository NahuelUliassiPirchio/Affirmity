...
class KapalabhatiMeditationDefinitionTest {
    ...
    @Test
    fun `default config runs 3 rounds of preparation-active-rest, 9 phases, ambient started and stopped once per round`() {
        val executor = RecordingCommandExecutor()
        val engine = MeditationEngine(kapalabhatiMeditationDefinition(), executor)
