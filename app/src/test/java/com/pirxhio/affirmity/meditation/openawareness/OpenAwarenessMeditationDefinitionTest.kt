...
class OpenAwarenessMeditationDefinitionTest {
    ...
    @Test
    fun `runs anchor, expand, then open awareness - 3 phases`() {
        val executor = RecordingCommandExecutor()
        val engine = MeditationEngine(openAwarenessMeditationDefinition(), executor)
