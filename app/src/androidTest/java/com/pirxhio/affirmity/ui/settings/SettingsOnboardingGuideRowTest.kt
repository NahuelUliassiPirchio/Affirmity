    ...
    fun tappingTheRowInvokesOnOpenOnboardingGuide() {
        ...
        composeTestRule.setContent {
            SettingsScreen(
                ...
                streakSettings = ChannelSettings(enabled = false, segments = emptySet()),
                healerSettings = ChannelSettings(enabled = false, segments = emptySet()),
                meditationReturnSettings = ChannelSettings(enabled = false, segments = emptySet()),
